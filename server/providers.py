...
class CodeMieProvider(Provider):
    ...
    def _bin() -> str | None:
        ...
        return shutil.which("codemie-claude", path=env_mod.login_path()) or shutil.which("codemie-claude")
    ...
    def stream(self, messages, max_tokens, temperature, tools=None):
        ...
        try:
            with tempfile.TemporaryDirectory() as td:
                # `codemie-claude` wraps Claude Code; `-p` leaks the wrapper's banner/greeting into
